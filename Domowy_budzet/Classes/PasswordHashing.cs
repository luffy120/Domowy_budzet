...
namespace Domowy_budzet
{
    ...
    {
        //Domyślna metoda hashowania używana w programie
        public static string CreatePasswordHash(string pwd)
        {
            return CreatePasswordHash(pwd, CreateSalt());
        }
        //Dodatkowa, opcjonalna, nie wykorzystywana w programie, w tej można ustawić "sól"
        ...
        //Walidacja hasła podanego - z hashem
